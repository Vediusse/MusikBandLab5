...
public class Validator {
    ...
    public void validatePerson(Person person) {
        ...
        validateIntegerNotNull(person.getHeight(), "Person height");
        validateColor(person.getEyeColor(), "Eye color");
        validateColor(person.getHairColor(), "Hair color");
        validateCountry(person.getNationality(), "Nationality");
    }
    ...
    public void validateId(int id, String propertyName) {
        if (id <= 0) {
